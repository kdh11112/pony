$(document).ready(function(){
        ...
        if(modelName === "AVANTE"){
        	$("#highLight1").text("더욱 스타일리시하게")
        	$("#highLight2").text("한층 더 진보된 기본기와 함께,")
        	$("#highLight3").text("디테일이 다른 새로운 라이프스타일이 시작됩니다.")
            ...
            $("#modelImg5").attr("src","https://imgauto-phinf.pstatic.net/20230313_5/auto_1678683342696IkfSe_JPEG/20230313135528_PiUOWYre.jpg")
            $("#modelImg6").attr("src","https://imgauto-phinf.pstatic.net/20230313_242/auto_1678683340753dnlXG_JPEG/20230313135527_zcwgRRvW.jpg")
            $("#designContent1").text("수평적인 그래픽을 확장한 디자인으로 더 낮고 와이드한 비례를 연출하여")
            $("#designContent2").text("‘파라메트릭 다이나믹스’를 강조하였습니다.")
        }else if(modelName === "SONATA"){
          	$("#highLight1").text("익숙함도 완전히 새롭게")
        	$("#highLight2").text("탄탄한 헤리티지와 선도적인 디자인,")
        	$("#highLight3").text("첨단 기술의 조합으로 재탄생했습니다.")
            ...
            $("#designContent1").text("미래지향적인 심리스 호라이즌 램프는 쏘나타의 과감해진 스타일을 완성합니다.")
            $("#designContent2").text("")
        }else if(modelName === "GRANDEUR"){
        	$("#highLight1").text("Outclass GRANDEUR")
        	$("#highLight2").text("전통과 미래, 세대와 취향, 기술과 감성의 경계를 지운")
        	$("#highLight3").text("새로운 경험을 선사합니다.")
            ...
            $("#designContent1").text("아름다운 비례 위에 매끈하게 다듬어진 면과 미래지향적인 수평형 램프 디자인을 더해")
            $("#designContent2").text("플래그십 세단의 고급스러움과 존재감을 완성하였습니다.")
        }else if(modelName === "PALISADE"){
        	$("#highLight1").text("당신의 모든 세상")
        	$("#highLight2").text("플래그십 SUV 팰리세이드와 함께")
        	$("#highLight3").text("당신만의 세상을 향한 멋진 여정을 준비하십시오.")
            ...
            $("#designContent1").text("플래그십 SUV답게 압도적인 존재감을 드러냅니다.")
            $("#designContent2").text("")
        }else if(modelName === "TUCSON"){
        	$("#highLight1").text("당신만의 특별한 공간")
        	$("#highLight2").text("더 오래 머물수록")
        	$("#highLight3").text("그 가치는 빛이 납니다.")
