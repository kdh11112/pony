...
<link type="text/css" rel="stylesheet" href="//img.pay.naver.net/o/wstatic/css/service/front/order/layerpopup.css?1691577253961">
				...
				<div class="order_content ">
					...
					<div class="orderendtxt_wrap pointplus_info">
						...
						<div class="orderendtxt_content">
							<p class="txt_oe">
								<span class="blind">주문이 정상적으로 완료되었습니다.</span>
							</p>
					...
					<div class="orderend_info">
						<div class="info_wrap">
							<h4>주문번호</h4>
							<a href="#" class="order_number _click(nmp.front.order.order_sheet.result.goUrl(https://order.pay.naver.com/orderStatus/2023081689911581)) _stopDefault">
								<strong>2023081689911581</strong>
							</a>
							<!--N=a:ctm.ordnumber-->
						</div>
						...
						<dl class="benefit_fold_panel on spot_benefit_pay">
							<dt class="fold_heading">
								<a href="#" class="_click(nmp.front.order.order_sheet.result.togglePayEventInfo()) _stopDefault">
									<strong> 포인트 혜택 </strong> <span class="benefit_spot_green">400원</span>
								</a>
								<!--N=a:ctm.benefit-->
							</dt>
						</dl>
					...
					<div class="cutting_line cutting_line_v3">
						<span class="ico_scissors"></span> <span class="shdw_left"></span> <span class="shdw_right"></span>
					</div>
					<div class="payment_agree_wrap">

						<button class="N=a:cpt.orderlist _click(nmp.front.order.order_sheet.result.goUrl(https://order.pay.naver.com/orderStatus/2023081689911581)) _stopDefault">
							<span class="txt_purchase">구매내역 보기</span>
						</button>
						<!--N=a:ctm.buylst-->
						<button class="N=a:cpt.home _click(nmp.front.order.order_sheet.result.goUrl(http://shopping.naver.com/home/p/index.nhn)) _stopDefault">
