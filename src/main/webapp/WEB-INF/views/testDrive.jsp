	...
	<div class="testDriveContent text-center">
		<form action="/addTestDrive" id="frm" method="post">
			...
			<input type="hidden" name="selectedShopNo" id="selectedShopNo" /> <input
				type="hidden" name="selectedModel" id="selectedModel" /> <input
				type="hidden" name="buttonTime" id="buttonTime" />
			<div class="agreeArea ">
					...
					<div class="agree-check" style="margin-top: -50px;">
						<div id="check1">
							<input class="form-check-input" type="checkbox" value=""
								...
								for="flexCheckDefault" id="checkLabel1"> (필수) 시승차 이용 및
								서비스 이용에 따른 주요 고지사항 및 이용약관 안내</label>
						</div>
					</div>
					<div class="agree-check">
						<div id="check2">
							<input class="form-check-input" type="checkbox" value=""
								...
								for="flexCheckDefault" id="checkLabel2"> (필수) 시승신청 개인정보
								수집 및 이용 동의</label>
						</div>
					</div>
					<div style="color: white;">empty</div>
				...
				<div class="accordion-item">
					<h2 class="accordion-header" id="headingOne">
						<button class="accordion-button collapsed" id="headingOneBtn"
							type="button" data-bs-target="#collapseOne" aria-expanded="false"
							aria-controls="collapseOne">시승모델 선택하기</button>
					</h2>
				...
				<div class="accordion-item">
					<h2 class="accordion-header" id="headingTwo">
						<button class="accordion-button collapsed" id="headingTwoBtn"
							type="button" data-bs-target="#collapseTwo" aria-expanded="false"
							aria-controls="collapseTwo">시승장소 선택하기</button>
					</h2>
				...
				<div class="accordion-item">
					<h2 class="accordion-header" id="headingThree">
						<button class="accordion-button collapsed" id="headingThreeBtn"
							type="button" data-bs-target="#collapseThree"
							aria-expanded="false" aria-controls="collapseThree">시승날짜
							선택하기</button>
					</h2>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title">(필수) 시승차 이용 및 서비스 이용에 따른 주요 고지사항 및
						이용약관 안내</h4>
				...
				<div class="modal-body">
					<div data-bs-spy="scroll" data-bs-target="#navbar-example2"
						...
						<p>①고객님의 시승차 운전이 불가하다고 판단 시 귀사 직원의 판단에 따라 즉시 시승이 중단/취소될 수 있으며
							향후 시승 이용이 제한될 수 있습니다.</p>
						...
						<p>시승시간은 총 1시간 또는 1시간 30분입니다. (시승시간은 예약 시간대별로 상이하며 거점별 운영 상황에
							따라 변경될 수 있습니다.)</p>
						<p>* long-time 시승 (총 2시간 30분)을 원하시는 경우 방문 희망 드라이빙라운지로 유선 연락
							주시길 바랍니다.</p>
						<p>해당 드라이빙라운지 예약 상황에 따라 희망하시는 차종의 시승 가능 여부를 안내드립니다.</p>
						<p>⑤시승 고객님의 안전한 운행을 위해 동승 시승을 희망하시는 경우 카마스터가 동승합니다.</p>
						<p>⑥계약 이력 또는 담당 카마스터가 있는 고객님이 동승 시승을 희망하시는 경우 담당 카마스터와 동승 시승
							가능 여부 확인 후 예약이 확정됩니다. 계약 이력이 있는 고객님은 담당 카마스터가 동승이 불가능한 경우, 동승 시승
							서비스 이용이 제한될 수 있습니다.</p>
						<p>⑦시승서비스는 고객님께서 차량을 구매하기 전 관심 차종을 경험할 수 있는 기회를 드리고자 제공되는
							서비스입니다. 따라서 개인적 용도로 시승차를 이용하려는 경우 시승이 제한될 수 있습니다. 많은 고객님께 시승서비스를
							제공하기 위해 고객님 한 분당 연간 6회까지 시승 신청이 가능합니다.</p>

						<h4 class="scrollspyHeading" id="scrollspyHeading1">2. 보험사항</h4>
						<p>상기 차량은 대인배상(Ⅰ,Ⅱ), 대물배상, 자기 신체, 자기 차량, 무보험 등의 보험에 가입되어 있으나,
							보험 가액을 초과하는 부분 및 보험 미적용 부분 (운전자 연령 한정 운전 특약 위반, 차량 사고 시 자차 부담금 최대
							10만원 고객 부담) 등에 대해서는 본인이 스스로 책임을 지는 동시에 귀사에 발생한 모든 손해를 배상할 것을
							약속합니다.</p>

						<h4 class="scrollspyHeading" id="scrollspyHeading1">3. 금지사항</h4>
						<p>본인은 귀사가 제공한 상기 차량을 상업적으로 이용하는 등 비정상적으로 운행하거나, 본인 외 제3자에게
							운행, 양도, 대여, 담보의 목적으로 제공하는 등의 행위를 일절 하지 않을 것을 약속합니다. 또한 주행 보조 기능
							(AEB 자동 긴급 제동 시스템, FCA 전방 충돌 방지 보조 등) 작동을 위하여 위험한 운전을 시도하지 않으며,
							항상 안전하게 운전할 것을 약속합니다.</p>

						<h4 class="scrollspyHeading" id="scrollspyHeading1">4. 책임사항</h4>
						<p>①본인은 위 보험 사항 및 금지사항, 유의사항을 위반하여 발생한 모든 민·형사상 책임을 부담합니다.</p>
						<p>②본인은 약정된 차량 반납 일시까지 상기 차량을 지정된 반납 장소에 반납하지 않거나 차량 반납 시 차량
							상태가 변동된 경우, 이로 인해 발생한 모든 손해에 대한 배상 책임을 부담합니다.</p>
						<p>③본인은 교통법규 미준수로 인한 벌금, 과태료 및 시승 운행 시 발생한 도로교통비 등을 부담합니다.
							위치정보 수집장치 부착 사실 고지 시승차량에 장착된 블루링크 단말을 통해 시승서비스 이용 시간 동안 시승차량 및
							고객님의 위치정보가 수집됨을 알려드립니다.</p>

					</div>

				</div>
				<div class="modal-footer">
					<button type="button" class="agree-btn btn btn-primary"
						id="agree-btn1">동의</button>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div data-bs-spy="scroll" data-bs-target="#navbar-example2"
						data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true"
						class="scrollspy-example bg-light p-3 rounded-2" tabindex="0">
						<h4 class="scrollspyHeading" id="scrollspyHeading1">. 개인정보 수집
							및 이용 목적</h4>
						...
						<h4 class="scrollspyHeading" id="scrollspyHeading1">. 개인정보의
							수집 항목</h4>
						<p>[필수 항목]</p>
						<p>- 고객 성명, 휴대전화 번호, 생년월일, 성별, 연계정보(CI), 주소(자택/직장), 시승정보(시승차종,
							차량번호, 시승일시), 시승차량 위치정보</p>
						<p>[선택 항목]</p>
						...
						<p style="margin-top: 50px;">고객님은 위의 개인정보 수집 이용에 대한 동의를 거부하실 수
							있습니다.</p>
