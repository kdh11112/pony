              ...
              <div class="card-header">
                ...
                <div class="table-responsive">
                  <table class="table table-hover">
                    ...
                    <tr>
                    	<td><%=count++ %></td>
                    	<td>${part.partName }<input type="hidden" name="partName" value="${part.partName }" /></td>
                    	<td>${part.partNo }<input type="hidden" name="partNo" value="${part.partNo }" /></td>
                    	<td class="text-center">${part.partPrice }<input type="hidden" name="partPrice" value="${part.partPrice }" /></td>
                    	<td class="text-right"><input type="text" name="partNumber" value="${part.partNumber }" /></td>
                    </tr>
                    <tbody id="tbodyPart">
                    <c:forEach var="technology" items="${technology}">
                    <tr>
                    	<td><%=count++ %><input type="hidden" name="count" value="<%=count %>" /></td>
                    	<td>${technology.technologyDetail}<input type="hidden" name="technologyDetail" value="${technology.technologyDetail}" /></td>
                    	<td>${technology.technologyNo}<input type="hidden" name="technologyCount" value="${technology.technologyNo}" /></td>
                    	<td class="text-center">${work.mechanicName }<input type="text" name="mechanicName" value="${technology.technologyNumber}" /></td>
                    	<td class="text-right">${technology.technologyPrice}<input type="hidden" name="technologyPrice" value="${technology.technologyPrice}" /></td>
                    </tr> 
                    </c:forEach>
                    </c:forEach>  
                    </tbody>
