						...
						<div class="card-body p-5 text-center">
							...
							<div class="form-outline mb-4">
								<input type="email" id="typeEmailX-2"
									class="form-control form-control-lg shadow-sm" /> <label
							...
							<div class="d-flex justify-content-center">
								<button class="btn btn-lg btn-block" 
									style="background-color: #dd4b39; color: white; width: 300px; height: 45px;">
									<i class="fab fa-google me-2" style="color: white;"></i> Sign in with google
								</button>
